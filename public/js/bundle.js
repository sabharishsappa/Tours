...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoic2FiaGFyaXNoMjAyMyIsImEiOiJjbGlyZ2UxMzIwNGp0M2dvNzY3NW8yZXllIn0.j85JRdmvI6fM5kLfZnnEpg';
      ...
      while (1) switch (_context.prev = _context.next) {
        ...
        case 7:
          ...
          if (_context.t0.response && _context.t0.response.data && _context.t0.response.data.message) {
            ...
            (0, _alerts.showAlert)('error', 'An error occurred during login');
          }
        case 10:
        case "end":
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(tourId) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          stripe = Stripe('pk_test_51NJuDdSIHYx4g6Fl7LHioFUBVTsdWZkBjDq3HH5QTKkkHYyBwOsA5U4rhv6MgVSCzUcHzLiDzFnon9krFh560iYv00ZQZD0NS1'); // 1) Get the Session from the api
          _context.next = 4;
